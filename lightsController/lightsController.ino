...
//FUNKBOX
int idex = 0; //-LED INDEX (0 to NUM_LEDS_PER_STRIP-1
...
void setup()
{
  ...
  FastLED.addLeds<CHIPSET, D8, COLOR_ORDER>(leds, NUM_LEDS_PER_STRIP);
...
void loop()
{
  ...
  if (effectString == "lightning")
  {
    ...
    ledlen = random8(NUM_LEDS_PER_STRIP - ledstart); //Determine length of flash (not to go beyond NUM_LEDS_PER_STRIP-1)
